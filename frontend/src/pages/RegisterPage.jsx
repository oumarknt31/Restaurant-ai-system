...
function RegisterPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      // Backend returns { user: { ... } }, but we don't need to store it here.
      // We simply send the user to the login page.
      if (!res.data?.user) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Join our Restaurant AI system to get personalized recommendations,
          faster ordering, and VIP perks.
        </p>
          ...
          <button
            ...
            onMouseDown={(e) => {
              ...
              e.currentTarget.style.boxShadow =
                "0 8px 20px rgba(8,145,178,0.5)";
            }}
            onMouseUp={(e) => {
              e.currentTarget.style.transform = "translateY(0)";
              e.currentTarget.style.boxShadow =
                "0 12px 30px rgba(8,145,178,0.55)";
            }}
            onMouseLeave={(e) => {
              e.currentTarget.style.transform = "translateY(0)";
              e.currentTarget.style.boxShadow =
